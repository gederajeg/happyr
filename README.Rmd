...
The ggplot2 codes for producing Figure 3.1 in Rajeg [-@rajeg_metaphorical_2018, Ch. 3] is wrapped into a function called `plot_cxn_interrater()`. The input data frame is `top_cxn_data`.
...
I design a helper function called `get_lexically_diverse_metaphors()` to retrieve the top-10 lexically diverse or creative metaphors [@rajeg_metaphorical_2018, Ch. 6]. These metaphors are those having relatively high type/token ratio and occurring at least three tokens in the sample.
