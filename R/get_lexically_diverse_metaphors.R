...
#'
#' @description This function calls the script to output the top-10 metaphors that have high percentage of lexical diversity in their linguistic manifestation.
#'     The lexical diversity is derived from the \code{type-per-token ratio (TTR)} measure (Rajeg, 2018, Chapter 6).
