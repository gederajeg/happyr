...
#'     The lexical creativity is derived from the \code{type-per-token ratio (TTR)} measure (Rajeg, 2019, Chapter 6). The alternative function with shorter name is \code{\link{get_creative_metaphors}}.
