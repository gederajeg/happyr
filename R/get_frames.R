...
#'
#' @description A utility function to get the descriptive data for the source frames of a metaphor (for the aggregated synonyms data or for a given synonym, if specified).
